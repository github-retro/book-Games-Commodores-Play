...
3014 PRINT TAB(6)"{reverse on} F1 SHIFT LEFT F3 TO SHIFT RIGHT";
3020 GET KEY$: IF KEY$="" THEN GOTO 3020
3030 IF KEY$="1" OR KEY$="2" OR KEY$="3" THEN GOTO 3100
3035 IF KEY$="{f1}" THEN GOTO 3050 
3040 IF KEY$="{f3}" THEN GOTO 3075
3045 GOTO 3020
3050 RX=BX+1: IF RX=4 THEN GOTO 3020
3055 BA(BX,BY)=BA(RX,RY): BA(RX,BY)=0
